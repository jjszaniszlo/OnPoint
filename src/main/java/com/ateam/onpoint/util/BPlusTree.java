package com.ateam.onpoint.util;
...
public class BPlusTree {
     ...
     */
    private void shiftDown(Node[] pointers) {
        Node[] newPointers = new Node[this.m + 1];
        if (pointers.length - 1 >= 0) System.arraycopy(pointers, 1, newPointers, 0, pointers.length - 1);
    }
    ...
    public class LeafNode extends Node {
        ...
        public LeafNode(int m, DictionaryPair dp) {
            ...
            this.minNumPairs = (int)((double) (m / 2) - 1);
                ...
                switch (tokens[0]) {
                    ...
                    case "Search":
                        ...
                        if (tokens.length == 3) {
                            ...
                            if (!values.isEmpty()) {
                                for (double v : values) { result.append(v).append(", "); }
                        ...
                        // Perform search operation
                            ...
                            result = new StringBuilder((value == null) ? "Null" :
